...
import { testVtex, testZendesk, testPowerBi, testSupabase, testOpenRouter, type TestResult } from "@/lib/connectors";
...
export async function POST(_req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    else if (conn.tipo === "openrouter") result = await testOpenRouter(config, secret);
